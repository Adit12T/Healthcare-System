...
<script type="text/javascript">
 function showData(value){ 
	...
	var url="patientadmitseachcotent.jsp";
	url=url+"?name="+value;
...
<div class="container_12">
		...
		<div class="box round first grid" style="height: 100%;">
		 <table align="center">
		 <tr><th>Search Patient</th><td><input maxlength="10" type="text" name="name" id="name" onkeyup="showData(this.value);" onkeypress="return alphadothyphen(event)" onblur="convertToUpper(this.id)"> </td></tr>
		 </table>
...
<table width="911" height="53" border="1" cellpadding="0" cellspacing="0" class="table">
  ...
  <tr>
    ...
    <td> <a href="discharge1.jsp?id=<%=map.get("admitid") %>"><img	alt="Discharge" title="Discharge" src="../mg/tickmark.png" width="15" height="15"></a></td>
  </tr>
  </pg:item>
  <% }%>
