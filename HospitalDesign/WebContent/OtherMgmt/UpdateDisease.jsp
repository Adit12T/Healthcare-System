...
<body>
	<div class="container_12">
		...
		<form action="../UpdateDisease" method="post">
			<fieldset>
				Diseas ID<input type="text" name="id" required="required"> Disease_Name<input required="required"
					type="text" name="dis"> Department<input type="text" required="required"
					name="dep">
