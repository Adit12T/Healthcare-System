...
<script type="text/javascript">
	function showData(value) {
		...
		var url = "olddischargerecordsearch.jsp";
		url = url + "?name=" + value;
		...
		<div class="grid_10" style="width: 97%;">
			<div class="box round first grid" style="height: 100%;">
				<table >
					<tr>
						<td>Patient Name</td>
						<td><input type="text" name="name" id="name" maxlength="10"
						onkeypress="return alphanumber(event)" onblur="convertToUpper(this.id)"
