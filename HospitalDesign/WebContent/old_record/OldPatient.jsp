		...
		<div class="grid_10" style="width: 97%;">
			<div class="box round first grid" style="height: 100%;">
				<table >
					<tr>
						<th>Patient Name</th>
						<td><input type="text" name="name" placeholder="id / name"id="name" maxlength="10"
							onkeyup="showData(this.value);" onkeypress="return alphanumber(event)" onblur="convertToUpper(this.id)"></td>
					</tr>
				</table>
				...
				<div id="mydiv" style="margin-top: 0px">
					<%
						Patient_old po = new Patient_old();
					...
					<table width="911" height="53" border="1" cellpadding="0"
						...
						<pg:paging indexSize="2" pageSize="5">
							<%
