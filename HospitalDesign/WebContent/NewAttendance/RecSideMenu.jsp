	...
	<div class="grid_2" style="width: 100%">
		<div class="box sidemenu">
			<div class="block" id="section-menu">
				...
				<li><a class="menuitem" href="TakeAttendance.jsp" target="subbody">Take Attendance</a>
						</li>
					<li><a class="menuitem" href="ViewAllEmp.jsp" target="subbody">View Attendance</a>
						</li>
						<li><a class="menuitem" href="Listofpendingsalary.jsp" target="subbody">Issue Salary</a>
						</li>
