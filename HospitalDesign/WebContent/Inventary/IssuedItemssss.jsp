...
<body
	...
	<div id="form_container">
		...
		<form action="../IssueItemServlet" name="f1" id="f1">
			<fieldset>
				...
				<center>
					<table>
						<tr>
							...
							<td><input type="text" name="mcompany" placeholder="Company Name"> </textarea></td>
						</tr>
						<tr>
							...
							<td><select name="iname" id="iname" placeholder="Item Name">
						...
						<tr>
							...
							<td><input type="text" name="rq" id="rq" ></td>
